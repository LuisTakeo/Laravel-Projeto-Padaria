CREATE DATABASE  IF NOT EXISTS `dbpadoca` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `dbpadoca`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: localhost    Database: dbpadoca
-- ------------------------------------------------------
...
CREATE TABLE `tbproduto` (
  ...
  `descrProduto` varchar(50) DEFAULT NULL,
...
-- Dump completed on 2023-08-31 22:20:58
